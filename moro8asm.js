...
var Module = typeof moro8asm !== 'undefined' ? moro8asm : {};
...
function compile(program) {
    ...
    // Compile
    const bytes_ptr = moro8asm.ccall("moro8asm_compile", "number", ["number", "number", "number"], [program_ptr, program_buffer.length, size_ptr]);
...
moro8asm.compile = compile;
  ...
  return moro8asm.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = moro8asm;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return moro8asm; });
else if (typeof exports === 'object')
  exports["moro8asm"] = moro8asm;
